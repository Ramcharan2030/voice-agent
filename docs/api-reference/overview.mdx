---
title: "Overview"
description: "Interact with SPX Voice programmatically via the REST API"
---
...
```
https://your-spx-voice-domain/api/v1
```

If you are using the hosted version, the base URL is `https://your-spx-voice-domain/api/v1`.
...
```bash
curl -X POST https://your-spx-voice-domain/api/v1/workflow/create/definition \
...
```bash
curl https://your-spx-voice-domain/api/v1/health
```
...
```json
{
  "status": "ok",
  "version": "1.0.0",
  "backend_api_endpoint": "https://your-spx-voice-domain",
  "deployment_mode": "oss",
  "auth_provider": "local"
}
```
