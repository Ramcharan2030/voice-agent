...
description: "You can create API Keys to trigger SPX Voice agents and Service Keys to use with Inference Providers"
---

The option to create the Keys are in https://your-spx-voice-domain/api-keys if you are using hosted version, or http://localhost:3010/api-keys if you are using the self hosted version.
