...
description: "Assemble a SPX Voice agent programmatically with the SDK and save it as a draft"
---
...
- An existing agent ID to save drafts against (create one in the SPX Voice UI or via [`POST /api/v1/workflow/create`](/api-reference/agents/create-from-template))
...
<CodeGroup>
```python Python
from spx_voice_sdk import SPXVoiceClient, Workflow
...
import { SPXVoiceClient, Workflow } from "@spx-voice/sdk";
