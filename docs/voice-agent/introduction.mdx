...
description: "SPX Voice provides UI components to build a voice Agent. The voice agent can be created by going to https://your-spx-voice-domain/workflow and then Creating a new Agent."
---
