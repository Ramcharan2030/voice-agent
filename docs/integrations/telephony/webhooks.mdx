...
description: "How SPX Voice handles telephony webhooks and audio streaming"
---

## Overview

SPX Voice uses webhooks to communicate with telephony providers for call events and audio streaming. Webhooks are automatically configured when you initiate calls.
