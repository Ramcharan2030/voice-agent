 ...
 */
export const createManagedUserApiV1SuperuserUsersPost = <ThrowOnError extends boolean = false>(options: Options<CreateManagedUserApiV1SuperuserUsersPostData, ThrowOnError>) => (options.client ?? client).post<CreateManagedUserApiV1SuperuserUsersPostResponses, CreateManagedUserApiV1SuperuserUsersPostErrors, ThrowOnError>({
...
/**
 * Recalculate Workflow Run Cost
 *
 * Rebuild provider cost info for a single run, including fresh CDR lookup.
 */
export const recalculateWorkflowRunCostApiV1SuperuserWorkflowRunsWorkflowRunIdRecalculateCostPost = <ThrowOnError extends boolean = false>(options: Options<RecalculateWorkflowRunCostApiV1SuperuserWorkflowRunsWorkflowRunIdRecalculateCostPostData, ThrowOnError>) => (options.client ?? client).post<RecalculateWorkflowRunCostApiV1SuperuserWorkflowRunsWorkflowRunIdRecalculateCostPostResponses, RecalculateWorkflowRunCostApiV1SuperuserWorkflowRunsWorkflowRunIdRecalculateCostPostErrors, ThrowOnError>({ url: '/api/v1/superuser/workflow-runs/{workflow_run_id}/recalculate-cost', ...options });
 ...
 */
export const retryDocumentProcessingApiV1KnowledgeBaseDocumentsDocumentUuidRetryPost = <ThrowOnError extends boolean = false>(options: Options<RetryDocumentProcessingApiV1KnowledgeBaseDocumentsDocumentUuidRetryPostData, ThrowOnError>) => (options.client ?? client).post<RetryDocumentProcessingApiV1KnowledgeBaseDocumentsDocumentUuidRetryPostResponses, RetryDocumentProcessingApiV1KnowledgeBaseDocumentsDocumentUuidRetryPostErrors, ThrowOnError>({ url: '/api/v1/knowledge-base/documents/{document_uuid}/retry', ...options });
 ...
 * Get Livekit Runtime
 */
export const getLivekitRuntimeApiV1LivekitRuntimeGet = <ThrowOnError extends boolean = false>(options?: Options<GetLivekitRuntimeApiV1LivekitRuntimeGetData, ThrowOnError>) => (options?.client ?? client).get<GetLivekitRuntimeApiV1LivekitRuntimeGetResponses, GetLivekitRuntimeApiV1LivekitRuntimeGetErrors, ThrowOnError>({ url: '/api/v1/livekit/runtime', ...options });

/**
 * Get Livekit Settings
 */
export const getLivekitSettingsApiV1LivekitSettingsGet = <ThrowOnError extends boolean = false>(options?: Options<GetLivekitSettingsApiV1LivekitSettingsGetData, ThrowOnError>) => (options?.client ?? client).get<GetLivekitSettingsApiV1LivekitSettingsGetResponses, GetLivekitSettingsApiV1LivekitSettingsGetErrors, ThrowOnError>({ url: '/api/v1/livekit/settings', ...options });

/**
 * Update Livekit Settings
 */
export const updateLivekitSettingsApiV1LivekitSettingsPut = <ThrowOnError extends boolean = false>(options: Options<UpdateLivekitSettingsApiV1LivekitSettingsPutData, ThrowOnError>) => (options.client ?? client).put<UpdateLivekitSettingsApiV1LivekitSettingsPutResponses, UpdateLivekitSettingsApiV1LivekitSettingsPutErrors, ThrowOnError>({
 ...
 * Setup Vobiz Livekit
 */
export const setupVobizLivekitApiV1LivekitVobizSetupPost = <ThrowOnError extends boolean = false>(options: Options<SetupVobizLivekitApiV1LivekitVobizSetupPostData, ThrowOnError>) => (options.client ?? client).post<SetupVobizLivekitApiV1LivekitVobizSetupPostResponses, SetupVobizLivekitApiV1LivekitVobizSetupPostErrors, ThrowOnError>({
 ...
 */
export const createLivekitSessionApiV1LivekitSessionWorkflowIdWorkflowRunIdPost = <ThrowOnError extends boolean = false>(options: Options<CreateLivekitSessionApiV1LivekitSessionWorkflowIdWorkflowRunIdPostData, ThrowOnError>) => (options.client ?? client).post<CreateLivekitSessionApiV1LivekitSessionWorkflowIdWorkflowRunIdPostResponses, CreateLivekitSessionApiV1LivekitSessionWorkflowIdWorkflowRunIdPostErrors, ThrowOnError>({
...
/**
 * Create Inbound Sip Dispatch Rule
 */
export const createInboundSipDispatchRuleApiV1LivekitSipDispatchRulesWorkflowIdPost = <ThrowOnError extends boolean = false>(options: Options<CreateInboundSipDispatchRuleApiV1LivekitSipDispatchRulesWorkflowIdPostData, ThrowOnError>) => (options.client ?? client).post<CreateInboundSipDispatchRuleApiV1LivekitSipDispatchRulesWorkflowIdPostResponses, CreateInboundSipDispatchRuleApiV1LivekitSipDispatchRulesWorkflowIdPostErrors, ThrowOnError>({
