...
/**
 * LiveKitRuntimeResponse
 */
export type LiveKitRuntimeResponse = {
    /**
     * Voice Runtime
     */
    voice_runtime: string;
...
/**
 * LiveKitSIPDispatchRuleRequest
 */
export type LiveKitSipDispatchRuleRequest = {
    /**
     * Trunk Ids
     */
...
/**
 * LiveKitSettingsRequest
 */
export type LiveKitSettingsRequest = {
    /**
     * Voice Runtime
     */
    voice_runtime?: string;
    ...
    /**
     * Livekit Token Ttl Seconds
     */
    livekit_token_ttl_seconds?: number;
    /**
     * Livekit Sip Inbound Host
     */
    livekit_sip_inbound_host?: string;
    /**
     * Livekit Sip Max Call Duration Seconds
     */
    livekit_sip_max_call_duration_seconds?: number;
};

/**
 * LiveKitSettingsResponse
 */
export type LiveKitSettingsResponse = {
    /**
     * Voice Runtime
     */
    voice_runtime: string;
    ...
    source: string;
    /**
     * Worker Managed By Api
     */
    worker_managed_by_api: boolean;
    /**
     * Worker Running
     */
     ...
     * Vobiz Sync Message
     */
    vobiz_sync_message?: string | null;
};
 ...
 */
export type RecalculateWorkflowRunCostResponse = {
    /**
     * Status
     */
    status: string;
...
export type VobizConfigurationRequest = {
    ...
    from_numbers?: Array<string>;
    /**
     * Livekit Sip Outbound Trunk Id
     */
    livekit_sip_outbound_trunk_id?: string | null;
    /**
     * Livekit Sip Inbound Trunk Id
     */
    livekit_sip_inbound_trunk_id?: string | null;
    /**
     * Livekit Sip Dispatch Rule Id
     */
    livekit_sip_dispatch_rule_id?: string | null;
    /**
    ...
    /**
     * Vobiz Sip Credential Id
     */
    vobiz_sip_credential_id?: string | null;
    /**
     * Vobiz Sip Username
     */
    vobiz_sip_username?: string | null;
    /**
     * Vobiz Sip Password
     */
    vobiz_sip_password?: string | null;
    /**
     * Vobiz Sip Realm
     */
    vobiz_sip_realm?: string | null;
    /**
     * Vobiz Sip Trunk Id
     */
    vobiz_sip_trunk_id?: string | null;
    /**
     * Vobiz Sip Domain
     */
    vobiz_sip_domain?: string | null;
    /**
     * Vobiz Sip Inbound Destination
     */
    vobiz_sip_inbound_destination?: string | null;
};
...
/**
 * VobizLiveKitSetupRequest
 */
export type VobizLiveKitSetupRequest = {
    /**
     * Livekit Url
     */
    livekit_url: string;
     ...
     * Livekit Client Url
     */
    livekit_client_url?: string | null;
    /**
     * Livekit Api Key
     */
    livekit_api_key: string;
    ...
    livekit_sip_max_call_duration_seconds?: number;
    /**
     * Provision Livekit Sip
     */
    provision_livekit_sip?: boolean;
    /**
     * Config Id
     */
    ...
    /**
     * Vobiz Application Id
     */
    vobiz_application_id?: string | null;
    /**
     * Phone Numbers
     */
 ...
 */
export type VobizLiveKitSetupResponse = {
    livekit: LiveKitSettingsResponse;
    /**
     * Telephony Config Id
     */
    telephony_config_id: number;
    /**
     * Telephony Config Name
     */
    telephony_config_name: string;
    /**
     * Telephony Config Created
     */
    telephony_config_created: boolean;
    /**
     * Imported Phone Numbers
     */
    imported_phone_numbers: number;
    /**
...
export type CreateManagedUserApiV1SuperuserUsersPostData = {
...
export type CreateManagedUserApiV1SuperuserUsersPostErrors = {
    /**
     * Not found
     */
    404: unknown;
...
export type CreateManagedUserApiV1SuperuserUsersPostError = CreateManagedUserApiV1SuperuserUsersPostErrors[keyof CreateManagedUserApiV1SuperuserUsersPostErrors];

export type CreateManagedUserApiV1SuperuserUsersPostResponses = {
    /**
     * Successful Response
     */
    200: UserResponse;
...
export type CreateManagedUserApiV1SuperuserUsersPostResponse = CreateManagedUserApiV1SuperuserUsersPostResponses[keyof CreateManagedUserApiV1SuperuserUsersPostResponses];
...
export type RecalculateWorkflowRunCostApiV1SuperuserWorkflowRunsWorkflowRunIdRecalculateCostPostData = {
    body?: never;
    headers?: {
        /**
         * Authorization
    ...
    query?: never;
    url: '/api/v1/superuser/workflow-runs/{workflow_run_id}/recalculate-cost';
};

export type RecalculateWorkflowRunCostApiV1SuperuserWorkflowRunsWorkflowRunIdRecalculateCostPostErrors = {
    /**
     * Not found
     */
    404: unknown;
...
export type RecalculateWorkflowRunCostApiV1SuperuserWorkflowRunsWorkflowRunIdRecalculateCostPostError = RecalculateWorkflowRunCostApiV1SuperuserWorkflowRunsWorkflowRunIdRecalculateCostPostErrors[keyof RecalculateWorkflowRunCostApiV1SuperuserWorkflowRunsWorkflowRunIdRecalculateCostPostErrors];

export type RecalculateWorkflowRunCostApiV1SuperuserWorkflowRunsWorkflowRunIdRecalculateCostPostResponses = {
    /**
     * Successful Response
     */
    200: RecalculateWorkflowRunCostResponse;
};

export type RecalculateWorkflowRunCostApiV1SuperuserWorkflowRunsWorkflowRunIdRecalculateCostPostResponse = RecalculateWorkflowRunCostApiV1SuperuserWorkflowRunsWorkflowRunIdRecalculateCostPostResponses[keyof RecalculateWorkflowRunCostApiV1SuperuserWorkflowRunsWorkflowRunIdRecalculateCostPostResponses];
...
export type RetryDocumentProcessingApiV1KnowledgeBaseDocumentsDocumentUuidRetryPostData = {
    body?: never;
    headers?: {
        /**
         * Authorization
    ...
    query?: never;
    url: '/api/v1/knowledge-base/documents/{document_uuid}/retry';
};

export type RetryDocumentProcessingApiV1KnowledgeBaseDocumentsDocumentUuidRetryPostErrors = {
    /**
     * Not found
     */
    404: unknown;
...
export type RetryDocumentProcessingApiV1KnowledgeBaseDocumentsDocumentUuidRetryPostError = RetryDocumentProcessingApiV1KnowledgeBaseDocumentsDocumentUuidRetryPostErrors[keyof RetryDocumentProcessingApiV1KnowledgeBaseDocumentsDocumentUuidRetryPostErrors];

export type RetryDocumentProcessingApiV1KnowledgeBaseDocumentsDocumentUuidRetryPostResponses = {
    /**
     * Successful Response
     */
    200: DocumentResponseSchema;
...
export type RetryDocumentProcessingApiV1KnowledgeBaseDocumentsDocumentUuidRetryPostResponse = RetryDocumentProcessingApiV1KnowledgeBaseDocumentsDocumentUuidRetryPostResponses[keyof RetryDocumentProcessingApiV1KnowledgeBaseDocumentsDocumentUuidRetryPostResponses];
...
export type GetLivekitRuntimeApiV1LivekitRuntimeGetData = {
    body?: never;
    path?: never;
    query?: never;
    url: '/api/v1/livekit/runtime';
};

export type GetLivekitRuntimeApiV1LivekitRuntimeGetErrors = {
    /**
     * Not found
     */
    404: unknown;
...
export type GetLivekitRuntimeApiV1LivekitRuntimeGetResponses = {
    /**
     * Successful Response
     */
    200: LiveKitRuntimeResponse;
};

export type GetLivekitRuntimeApiV1LivekitRuntimeGetResponse = GetLivekitRuntimeApiV1LivekitRuntimeGetResponses[keyof GetLivekitRuntimeApiV1LivekitRuntimeGetResponses];

export type GetLivekitSettingsApiV1LivekitSettingsGetData = {
    body?: never;
    headers?: {
        /**
         * Authorization
    ...
    path?: never;
    query?: never;
    url: '/api/v1/livekit/settings';
};

export type GetLivekitSettingsApiV1LivekitSettingsGetErrors = {
    /**
     * Not found
     */
    404: unknown;
...
export type GetLivekitSettingsApiV1LivekitSettingsGetError = GetLivekitSettingsApiV1LivekitSettingsGetErrors[keyof GetLivekitSettingsApiV1LivekitSettingsGetErrors];

export type GetLivekitSettingsApiV1LivekitSettingsGetResponses = {
    /**
     * Successful Response
     */
    200: LiveKitSettingsResponse;
};

export type GetLivekitSettingsApiV1LivekitSettingsGetResponse = GetLivekitSettingsApiV1LivekitSettingsGetResponses[keyof GetLivekitSettingsApiV1LivekitSettingsGetResponses];

export type UpdateLivekitSettingsApiV1LivekitSettingsPutData = {
    body: LiveKitSettingsRequest;
    headers?: {
        /**
         * Authorization
         */
...
export type UpdateLivekitSettingsApiV1LivekitSettingsPutErrors = {
    /**
     * Not found
     */
    404: unknown;
...
export type UpdateLivekitSettingsApiV1LivekitSettingsPutError = UpdateLivekitSettingsApiV1LivekitSettingsPutErrors[keyof UpdateLivekitSettingsApiV1LivekitSettingsPutErrors];

export type UpdateLivekitSettingsApiV1LivekitSettingsPutResponses = {
    /**
     * Successful Response
     */
    200: LiveKitSettingsResponse;
...
export type UpdateLivekitSettingsApiV1LivekitSettingsPutResponse = UpdateLivekitSettingsApiV1LivekitSettingsPutResponses[keyof UpdateLivekitSettingsApiV1LivekitSettingsPutResponses];

export type SetupVobizLivekitApiV1LivekitVobizSetupPostData = {
    body: VobizLiveKitSetupRequest;
    headers?: {
        /**
         * Authorization
         */
    ...
    path?: never;
    query?: never;
    url: '/api/v1/livekit/vobiz/setup';
};

export type SetupVobizLivekitApiV1LivekitVobizSetupPostErrors = {
    /**
     * Not found
     */
    404: unknown;
...
export type SetupVobizLivekitApiV1LivekitVobizSetupPostError = SetupVobizLivekitApiV1LivekitVobizSetupPostErrors[keyof SetupVobizLivekitApiV1LivekitVobizSetupPostErrors];

export type SetupVobizLivekitApiV1LivekitVobizSetupPostResponses = {
    /**
     * Successful Response
     */
    200: VobizLiveKitSetupResponse;
};

export type SetupVobizLivekitApiV1LivekitVobizSetupPostResponse = SetupVobizLivekitApiV1LivekitVobizSetupPostResponses[keyof SetupVobizLivekitApiV1LivekitVobizSetupPostResponses];

export type CreateLivekitSessionApiV1LivekitSessionWorkflowIdWorkflowRunIdPostData = {
    ...
    query?: never;
    url: '/api/v1/livekit/session/{workflow_id}/{workflow_run_id}';
};

export type CreateLivekitSessionApiV1LivekitSessionWorkflowIdWorkflowRunIdPostErrors = {
    /**
     * Not found
     */
    404: unknown;
...
export type CreateLivekitSessionApiV1LivekitSessionWorkflowIdWorkflowRunIdPostError = CreateLivekitSessionApiV1LivekitSessionWorkflowIdWorkflowRunIdPostErrors[keyof CreateLivekitSessionApiV1LivekitSessionWorkflowIdWorkflowRunIdPostErrors];

export type CreateLivekitSessionApiV1LivekitSessionWorkflowIdWorkflowRunIdPostResponses = {
    /**
     * Successful Response
     */
    200: LiveKitSessionResponse;
};

export type CreateLivekitSessionApiV1LivekitSessionWorkflowIdWorkflowRunIdPostResponse = CreateLivekitSessionApiV1LivekitSessionWorkflowIdWorkflowRunIdPostResponses[keyof CreateLivekitSessionApiV1LivekitSessionWorkflowIdWorkflowRunIdPostResponses];

export type CreateInboundSipDispatchRuleApiV1LivekitSipDispatchRulesWorkflowIdPostData = {
    body: LiveKitSipDispatchRuleRequest;
    headers?: {
        /**
         * Authorization
         */
    ...
    query?: never;
    url: '/api/v1/livekit/sip/dispatch-rules/{workflow_id}';
};

export type CreateInboundSipDispatchRuleApiV1LivekitSipDispatchRulesWorkflowIdPostErrors = {
    /**
     * Not found
     */
    404: unknown;
...
export type CreateInboundSipDispatchRuleApiV1LivekitSipDispatchRulesWorkflowIdPostError = CreateInboundSipDispatchRuleApiV1LivekitSipDispatchRulesWorkflowIdPostErrors[keyof CreateInboundSipDispatchRuleApiV1LivekitSipDispatchRulesWorkflowIdPostErrors];

export type CreateInboundSipDispatchRuleApiV1LivekitSipDispatchRulesWorkflowIdPostResponses = {
    /**
     * Successful Response
     */
    200: unknown;
