...
import { LiveKitRuntimePanel } from "@/components/telephony/LiveKitRuntimePanel";
import { VobizLiveKitSetupWizard } from "@/components/telephony/VobizLiveKitSetupWizard";
import {
  AlertDialog,
  AlertDialogAction,
  AlertDialogCancel,
...
export default function TelephonyConfigurationsPage() {
  ...
  }, [fetchItems, refreshWarnings, refreshAppConfig]);
  ...
  return (
    <div className="min-h-screen bg-background">
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="mb-6">
          <VobizLiveKitSetupWizard onSaved={onSaved} />
        </div>

        <div className="mb-6">
          <LiveKitRuntimePanel onSaved={onSaved} />
        </div>
