...
export default function APIKeysPage() {
    ...
    const fetchServiceKeys = useCallback(async () => {
        ...
        // Follow the pattern from UserConfigContext - check both loading and user
        if (loading || !user || !hostedServicesEnabled) {
    ...
    }, [loading, user, getAccessToken, showServiceArchived, hostedServicesEnabled]);
                ...
                <div className="max-w-6xl mx-auto">
                    ...
                    <Card className="mb-6">
                        <CardHeader>
                            <div className="flex justify-between items-center">
                                <div>
                                    <CardTitle>Hosted Service Keys</CardTitle>
                                    <CardDescription>
                                        Manage hosted AI service keys for LLM, TTS, and STT access
                                    </CardDescription>
                                </div>
                                <div className="flex gap-2">
                                    ...
                                    {canCreateServiceKey ? (
                                        ...
                                        <span className="text">
                                            Hosted service-key creation is disabled in this deployment.
                                        </span>
                                    )}
                                </div>
                            </div>
            ...
            <Dialog open={isCreateServiceDialogOpen} onOpenChange={setIsCreateServiceDialogOpen}>
                <DialogContent>
                    <DialogHeader>
                        ...
                        <DialogDescription>
                            Create a hosted service key for LLM, TTS, and STT access
                        </DialogDescription>
                    </DialogHeader>
                    <div className="grid gap-4 py-4">
                        <div className="grid gap-2">
                        ...
                        <div className="space-y-4">
                            ...
                            <div className="p-4 bg-blue-500/10 border border-blue-500/20 rounded-lg">
                                <p className="text-sm text-blue-600 dark:text-blue-500">
                                    This key provides access to hosted AI services including LLM, Text-to-Speech, and Speech-to-Text.
