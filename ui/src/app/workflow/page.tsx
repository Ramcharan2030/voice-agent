    ...
    return (
        <div className="container mx-auto px-4 py-8">
            ...
            <div className="mb-8 relative animate-fade-in-up">
                ...
                <div className="absolute -top-10 -right-10 w-64 h-64 bg-gradient-to-br from-blue-500/5 to-purple-500/5 rounded-full blur-3xl -z-10" />

                <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                    <div>
                        <div className="flex items-center gap-2 mb-2">
                            <div className="h-1.5 w-8 bg-gradient-to-r from-blue-500 to-cyan-500 rounded-full" />
                            <span className="text-xs font-semibold uppercase tracking-wider text-muted-foreground">Voice Agents</span>
                        </div>
                        <h1 className="text-3xl font-bold tracking-tight">Your Agents</h1>
                        <p className="text-muted-foreground mt-1">Create and manage intelligent voice agents</p>
                    </div>
