...
# Default Telugu voice for Sarvam v3 examples.
SARVAM_DEFAULT_TELUGU_VOICE = "leda"
SARVAM_DEFAULT_TELUGU_MODEL = "bulbul:v3"
SARVAM_LANGUAGES = [
    "bn-IN",
    "en-IN",
    "gu-IN",
...
GOOGLE_EMBEDDING_MODELS = ["gemini-embedding-001"]
