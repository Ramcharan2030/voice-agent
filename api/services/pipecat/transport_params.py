...
# closes its turn. Realtime audio chunks arrive far more frequently than this,
# so keep the fallback tight enough that barge-in/tool drains feel immediate.
REALTIME_BOT_VAD_STOP_SECS = 0.12
