...
This module implements the telephony provider abstraction for SPX Voice. For user-facing documentation, see `docs/integrations/telephony/overview.mdx`.
...
See the [Custom Provider Guide](/docs/integrations/telephony/custom) in the documentation for detailed implementation instructions.
...
- [User Documentation](/docs/integrations/telephony/overview)
- [Twilio Integration](/docs/integrations/telephony/twilio)
- [Custom Providers](/docs/integrations/telephony/custom)
- [Webhooks Guide](/docs/integrations/telephony/webhooks)
