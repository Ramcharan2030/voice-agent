...
SINGLE_ORGANIZATION_MODE = (
    os.getenv("SINGLE_ORGANIZATION_MODE", "true").lower() == "true"
)
MANAGED_ORGANIZATION_PROVIDER_ID = os.getenv(
    "MANAGED_ORGANIZATION_PROVIDER_ID",
    "managed_single_org",
)
HOSTED_MPS_SECRET_KEY = os.getenv("HOSTED_MPS_SECRET_KEY", None)
MPS_API_URL = os.getenv("MPS_API_URL", "")
DISABLE_HOSTED_CLOUD = os.getenv("DISABLE_HOSTED_CLOUD", "true").lower() == "true"
...
LIVEKIT_AGENT_NAME = os.getenv("LIVEKIT_AGENT_NAME", "spx-voice").strip()
LIVEKIT_ROOM_PREFIX = os.getenv("LIVEKIT_ROOM_PREFIX", "spx-voice").strip()
LIVEKIT_TOKEN_TTL_SECONDS = int(os.getenv("LIVEKIT_TOKEN_TTL_SECONDS", "3600"))
LIVEKIT_SIP_OUTBOUND_TRUNK_ID = os.getenv("LIVEKIT_SIP_OUTBOUND_TRUNK_ID", "").strip()
LIVEKIT_SIP_DEFAULT_FROM_NUMBER = os.getenv(
    "LIVEKIT_SIP_DEFAULT_FROM_NUMBER", ""
).strip()
LIVEKIT_SIP_INBOUND_HOST = (
    os.getenv("LIVEKIT_SIP_INBOUND_HOST")
    or os.getenv("LIVEKIT_SIP_INBOUND_URI")
    or ""
).strip()
LIVEKIT_SIP_MAX_CALL_DURATION_SECONDS = int(
    os.getenv("LIVEKIT_SIP_MAX_CALL_DURATION_SECONDS", "1800")
)
LIVEKIT_WORKER_MANAGED_BY_API = (
    os.getenv("LIVEKIT_WORKER_MANAGED_BY_API", "false").lower() == "true"
)
...
DEFAULT_INBOUND_CONCURRENCY_LIMIT = int(
    os.getenv(
        "DEFAULT_INBOUND_CONCURRENCY_LIMIT",
        os.getenv("INBOUND_CONCURRENT_CALL_LIMIT", "4"),
    )
)
INBOUND_QUEUE_MAX_WAIT_SECONDS = int(os.getenv("INBOUND_QUEUE_MAX_WAIT_SECONDS", "180"))
INBOUND_QUEUE_RETRY_SECONDS = int(os.getenv("INBOUND_QUEUE_RETRY_SECONDS", "10"))
